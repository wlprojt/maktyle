...
export default async function CustomBottles() {
        ...
        <div className="mb-10 flex items-end justify-between gap-5">
          <div>
            ...
            <p className="mt-3 text-slate-500">
              Design personalized water bottles with your favorite photos, names, logos, or custom artwork.
            </p>
          </div>

          <Link
            href="/shop?category=Bottle"
