...
export default async function PhoneCases() {
        ...
        <div className="mb-10 flex items-end justify-between gap-5">
          <div>
            ...
            <p className="mt-3 text-slate-500">
              Design your own personalized mobile covers for every phone model.
            </p>
          </div>

          <Link
            href="/shop?category=Phone%20Case"
