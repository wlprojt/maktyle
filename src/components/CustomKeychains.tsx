...
export default async function CustomKeychains() {
        ...
        <div className="mb-10 flex items-end justify-between gap-5">
          <div>
            ...
            <p className="mt-3 text-slate-500">
              Create personalized keychains with your favorite photos, names, initials, or custom designs.
            </p>
          </div>
