        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-5 py-10 lg:flex-row lg:px-8">
          ...
          <div className="flex w-full max-w-lg rounded-full bg-white p-2">
            <input
              ...
              className="flex-1 rounded-full px-5 text-gray-800 outline-none"
            />

            <button className="flex items-center gap-2 rounded-full bg-purple-600 px-6 py-3 font-semibold transition hover:bg-purple-700">
              Subscribe
              <ArrowRight size={18} />
            </button>
          </div>
